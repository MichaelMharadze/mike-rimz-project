    ...
    >
      ...
      >
        ...
        >
          ...
          Admin Dashboard - Rims
        </h2>

        <div style={{ display: 'flex', gap: '1rem' }}>
      <button
  onClick={() => navigate('/manage-rims')} // make sure route matches App.js
  style={{
  ...
  Manage Rims
      ...
      >
        ...
        <ul style={{ marginTop: '10px', paddingLeft: '20px' }}>
          <li>Upload new rims</li>
          <li>Edit current listings</li>
          <li>Remove old or sold rims</li>
        </ul>
      </section>
    </div>
  );
